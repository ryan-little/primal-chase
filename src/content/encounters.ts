// GENERATED by tools/port-content.mjs from Primal-Chase-Opus/js/encounters.js
    ...
    "actions": [
      {
        "key": "drink",
        "name": "Dig",
        "description": "Dig into the dry riverbed in search of water",
        "chance": 0.5
      }
    ],
    "modifiers": {},
    ...
    "actions": [
      {
        "key": "drink",
        "name": "Drink",
        "description": "Drink from the watering hole",
        "chance": 1
      }
    ],
    "modifiers": {},
    ...
    "actions": [
      {
        "key": "eat",
        "name": "Scavenge",
        "description": "Search the burn for small animals caught in the fire",
        "chance": 0.6
      }
    ],
    "modifiers": {
    ...
    "actions": [
      {
        "key": "drink",
        "name": "Dig",
        "description": "Dig at the ravine bottom for trapped moisture",
        "chance": 0.4
      }
    ],
    "modifiers": {
    ...
    "actions": [
      {
        "key": "drink",
        "name": "Dig",
        "description": "Dig in the sand for subsurface water",
        "chance": 0.35
      }
    ],
    "modifiers": {
    ...
    "actions": [
      {
        "key": "drink",
        "name": "Search",
        "description": "Search the roots for seeping groundwater",
        "chance": 0.55
      }
    ],
    "modifiers": {
    ...
    "actions": [
      {
        "key": "drink",
        "name": "Dig",
        "description": "Dig into the soft clay for trapped water",
        "chance": 0.4
      }
    ],
    "modifiers": {
    ...
    "actions": [
      {
        "key": "drink",
        "name": "Split Stem",
        "description": "Bite open a bamboo stalk for the water stored inside",
        "chance": 0.6
      }
    ],
    "modifiers": {
    ...
    "actions": [
      {
        "key": "eat",
        "name": "Forage",
        "description": "Search the rotting wood for grubs and trapped animals",
        "chance": 0.7
      }
    ],
    "modifiers": {
    ...
    "actions": [
      {
        "key": "drink",
        "name": "Drink",
        "description": "Drink from the water pooled among the reed roots",
        "chance": 0.85
      }
    ],
    "modifiers": {
    ...
    "actions": [
      {
        "key": "eat",
        "name": "Hunt",
        "description": "Hunt the mopane worms clustered on the bark",
        "chance": 0.75
      }
    ],
    "modifiers": {
    ...
    "actions": [
      {
        "key": "eat",
        "name": "Scavenge",
        "description": "Search the ash for animals killed in the blaze",
        "chance": 0.55
      }
    ],
    "modifiers": {
...
export const opportunities: OpportunityEntry[] = [
  {
    "id": "vulture",
    ...
    "actions": [
      {
        "key": "eat",
        "name": "Scavenge",
        "description": "Investigate what the vultures are circling",
        "chance": 0.75
      }
    ],
    "modifiers": {}
    ...
    "actions": [
      {
        "key": "eat",
        "name": "Scavenge",
        "description": "Crack the bones for marrow",
        "chance": 0.4
      }
    ],
    "modifiers": {}
    ...
    "actions": [
      {
        "key": "eat",
        "name": "Feed",
        "description": "Break into the mound for a protein-rich meal",
        "chance": 0.65
      }
    ],
    "modifiers": {}
    ...
    "actions": [
      {
        "key": "eat",
        "name": "Hunt",
        "description": "Snatch the lizards for a quick meal",
        "chance": 0.8
      }
    ],
    "modifiers": {}
    ...
    "actions": [
      {
        "key": "eat",
        "name": "Scavenge",
        "description": "Tear what you can from the carcass",
        "chance": 0.55
      }
    ],
    "modifiers": {}
    ...
    "actions": [
      {
        "key": "drink",
        "name": "Wallow",
        "description": "Roll in the mud to cool down and coat your skin",
        "chance": 0.9
      }
    ],
    "modifiers": {}
    ...
    "actions": [
      {
        "key": "eat",
        "name": "Hunt",
        "description": "Follow the tracks and attempt a kill",
        "chance": 0.5
      }
    ],
    "modifiers": {}
    ...
    "actions": [
      {
        "key": "eat",
        "name": "Forage",
        "description": "Search the rotting wood for grubs and insects",
        "chance": 0.7
      }
    ],
    "modifiers": {}
    ...
    "actions": [
      {
        "key": "eat",
        "name": "Dig",
        "description": "Dig out whatever lives in this burrow",
        "chance": 0.45
      }
    ],
    "modifiers": {}
    ...
    "actions": [
      {
        "key": "eat",
        "name": "Hunt",
        "description": "Attempt to catch one of the hyrax",
        "chance": 0.6
      }
    ],
    "modifiers": {}
    ...
    "actions": [
      {
        "key": "eat",
        "name": "Eat",
        "description": "Eat the fallen figs for moisture and energy",
        "chance": 1
      }
    ],
    "modifiers": {}
    ...
    "actions": [
      {
        "key": "eat",
        "name": "Feed",
        "description": "Snap up grasshoppers as you move",
        "chance": 0.9
      }
    ],
    "modifiers": {}
    ...
    "actions": [
      {
        "key": "eat",
        "name": "Steal",
        "description": "Climb and steal the cached kill",
        "chance": 0.65
      }
    ],
    "modifiers": {}
    ...
    "actions": [
      {
        "key": "eat",
        "name": "Ambush",
        "description": "Wait beside the burrow for its occupant to emerge",
        "chance": 0.5
      }
    ],
    "modifiers": {}
    ...
    "actions": [
      {
        "key": "eat",
        "name": "Pry",
        "description": "Attempt to pry the pangolin open",
        "chance": 0.25
      }
    ],
    "modifiers": {}
    ...
    "actions": [
      {
        "key": "eat",
        "name": "Take",
        "description": "Bring down the calf for a full meal",
        "chance": 0.85
      }
    ],
    "modifiers": {}
    ...
    "actions": [
      {
        "key": "eat",
        "name": "Follow",
        "description": "Follow the honey guide to a beehive",
        "chance": 0.7
      }
    ],
    "modifiers": {}
    ...
    "actions": [
      {
        "key": "eat",
        "name": "Pounce",
        "description": "Snatch a spring hare from its leap",
        "chance": 0.55
      }
    ],
    "modifiers": {}
    ...
    "actions": [
      {
        "key": "eat",
        "name": "Raid Nest",
        "description": "Dig into the nest for an easy meal",
        "chance": 0.8
      }
    ],
    "modifiers": {}
    ...
    "actions": [
      {
        "key": "eat",
        "name": "Hunt Grazers",
        "description": "Stalk the small animals feeding on new growth",
        "chance": 0.6
      }
    ],
    "modifiers": {
    ...
    "actions": [
      {
        "key": "drink",
        "name": "Drink",
        "description": "Lap water from the bark hollow",
        "chance": 1
      }
    ],
    "modifiers": {}
    ...
    "actions": [
      {
        "key": "eat",
        "name": "Stalk",
        "description": "Close the distance and attempt a hunt",
        "chance": 0.35
      }
    ],
    "modifiers": {
    ...
    "actions": [
      {
        "key": "eat",
        "name": "Scavenge",
        "description": "Search below their roost for scraps of what they fed on",
        "chance": 0.6
      }
    ],
    "modifiers": {}
    ...
    "actions": [
      {
        "key": "eat",
        "name": "Take",
        "description": "Snatch the torpid lizards from the stone",
        "chance": 0.9
      }
    ],
    "modifiers": {}
    ...
    "actions": [
      {
        "key": "eat",
        "name": "Feed",
        "description": "Snatch crickets from the grass as you move",
        "chance": 0.85
      }
    ],
    "modifiers": {}
    ...
    "actions": [
      {
        "key": "eat",
        "name": "Hunt",
        "description": "Follow the scent trail in the dark",
        "chance": 0.4
      }
    ],
    "modifiers": {}
...
export const pressures: PressureEntry[] = [
  {
    "id": "overheating",
    "name": "overheating",
  ...
  },
  {
    ...
    "condition": (state, ctx) => state.day >= 5 && !ctx.usedOldTerritory,
    "fallbackCondition": false,
    "modifiers": {
      "trot": {
        "stamina": 3
...
export const signatures: SignatureEntry[] = [
    ...
    "choices": [
      {
        "key": "push",
        "name": "Push",
        "description": "Sprint hard — cover ground but burn through stamina and heat",
        "effects": null
      },
      {
        "key": "trot",
        "name": "Trot",
        "description": "Move at a steady pace — moderate distance, manageable cost",
        "effects": null
      },
      {
        "key": "rest",
        "name": "Rest",
        "description": "Hold position — recover strength, but the hunters close in",
        "effects": null
      }
    ]
  },
    ...
    "choices": [
      {
        "key": "push",
        "name": "Push",
        "description": "Press on through darkness — slower, but the hunters are camped",
        "effects": null
      },
      {
        "key": "trot",
        "name": "Trot",
        "description": "Move carefully through the night — less heat, less thirst",
        "effects": null
      },
      {
        "key": "rest",
        "name": "Rest",
        "description": "Rest and recover — the safest time to restore your body",
        "effects": null
      }
    ]
  },
    ...
    "choices": [
      {
        ...
        "description": "Swim across — mask your scent and lose the hunters, but risk the current",
        "effects": {
          "heat": -20,
          "stamina": -25,
          "thirst": -100,
        ...
        "risk": {
          ...
          "text": "The current pulls you under briefly. You emerge on the far bank, gasping, bruised against the stones."
        }
      },
      {
        "key": "follow",
        "name": "Follow the Bank",
        "description": "Follow the river downstream — safer, find a crossing, drink along the way",
        "effects": {
          "heat": 5,
          "stamina": -10,
          "thirst": -100,
      ...
      },
      {
        "key": "push",
        "name": "Push Past",
        "description": "Ignore the river and keep running",
        "effects": null,
        "distance": null
      }
    ]
    ...
    "choices": [
      {
        "key": "wade",
        "name": "Wade Through",
        "description": "Push through the floodwater before it deepens — dangerous but erases your trail",
        "effects": {
          "heat": -15,
          "stamina": -30,
          "thirst": -100,
        ...
        "risk": {
          ...
          "text": "The water hits harder than you expected. You are tumbled, scraped raw against hidden rocks, but you keep your feet."
        }
      },
      {
        "key": "wait",
        "name": "Wait It Out",
        "description": "Rest until the flood passes — safe but the hunters close in",
        "effects": {
          "heat": -15,
          "stamina": 15,
          "thirst": -50,
      ...
      {
        "key": "push",
        "name": "Push Along the Edge",
        "description": "Run along the flood's edge to find dry ground",
        "effects": null,
        "distance": null
      }
    ]
  },
  {
    ...
    "choices": [
      {
        "key": "run_rain",
        "name": "Run in the Rain",
        "description": "Push through the downpour — your tracks wash away, cool your body",
        "effects": {
          "heat": -30,
          "stamina": -15,
          "thirst": -100,
      ...
      },
      {
        "key": "shelter",
        "name": "Find Shelter",
        "description": "Wait out the storm under cover — rest and drink",
        "effects": {
          "heat": -25,
          "stamina": 20,
          "thirst": -100,
      ...
      },
      {
        "key": "trot",
        "name": "Trot Steadily",
        "description": "Move at a careful pace through the rain",
        "effects": null,
        "distance": null
      }
    ]
    ...
    "choices": [
      {
        "key": "cross_mud",
        "name": "Cross the Mud",
        "description": "Struggle through — exhausting but confuses the trail",
        "effects": {
          "heat": 15,
          "stamina": -30,
          "thirst": 10,
      ...
      },
      {
        "key": "skirt",
        "name": "Go Around",
        "description": "Skirt the edge — slower but easier going",
        "effects": {
          "heat": 10,
          "stamina": -10,
          "thirst": 5,
      ...
      {
        "key": "rest",
        "name": "Rest at the Edge",
        "description": "Rest here before deciding",
        "effects": null,
        "distance": null
      }
    ]
    ...
    "choices": [
      {
        "key": "fight",
        "name": "Challenge Them",
        "description": "Drive the hyenas off and claim the kill — risk injury",
        "effects": {
          "heat": 20,
          "stamina": -20,
          "thirst": 10,
        ...
        "risk": {
          ...
          "text": "They don't give way easily. Teeth find your flank before they scatter, and the wound is hot and deep."
        }
      },
      {
        "key": "wait_scraps",
        "name": "Wait for Scraps",
        "description": "Wait until they've had their fill, then take what's left",
        "effects": {
          "heat": 5,
          "stamina": 5,
          "thirst": 5,
    ...
    "choices": [
      {
        "key": "hunt",
        "name": "Take the Kill",
        "description": "Sprint and bring it down — a full meal at significant energy cost",
        "effects": {
          "heat": 25,
          "stamina": -25,
          "thirst": -30,
      ...
      {
        "key": "stalk",
        "name": "Follow Until It Falls",
        "description": "Trail it patiently — less energy but the hunters gain ground",
        "effects": {
          "heat": 10,
          "stamina": -5,
          "thirst": 5,
      ...
      },
      {
        "key": "leave",
        "name": "Leave It",
        "description": "You are the hunted now, not the hunter",
        "effects": null,
        "distance": null
      }
    ]
    ...
    "choices": [
      {
        "key": "raid",
        "name": "Raid the Hive",
        "description": "Tear it open and eat — stings are painful but honey is pure energy",
        "effects": {
          "heat": 15,
          "stamina": -10,
          "thirst": -20,
        ...
        "risk": {
          ...
          "text": "The bees descend in a furious cloud. Every sting is a point of fire, swelling your muzzle and eyes."
        }
      },
      {
        "key": "leave",
        "name": "Move On",
        "description": "Not worth the cost",
        "effects": null,
        "distance": null
      }
    ]
    ...
    "choices": [
      {
        "key": "steal",
        "name": "Steal an Egg",
        "description": "Grab one and run — risk the ostrich's wrath",
        "effects": {
          "heat": 15,
          "stamina": -15,
          "thirst": -25,
        ...
        "risk": {
          ...
          "text": "The ostrich charges with terrifying speed. A kick catches your ribs before you can escape with the egg."
        }
      },
      {
        "key": "leave",
        "name": "Give It Wide Berth",
        "description": "An ostrich kick can shatter bone",
        "effects": null,
        "distance": null
      }
    ]
    ...
    "choices": [
      {
        "key": "through",
        "name": "Go Through",
        "description": "Risk the narrows — faster but dangerous if hunters are close",
        "effects": {
          "heat": -10,
          "stamina": -15,
          "thirst": 5,
      ...
      },
      {
        "key": "around",
        "name": "Go Around",
        "description": "Safer but costs significant time",
        "effects": {
          "heat": 15,
          "stamina": -20,
          "thirst": 10,
      ...
      {
        "key": "rest",
        "name": "Rest at the Rim",
        "description": "Consider your options while you recover",
        "effects": null,
        "distance": null
      }
    ]
  },
  {
    ...
    "choices": [
      {
        "key": "through_fire",
        "name": "Run Through the Fire Line",
        "description": "Sprint through the thinnest point — extreme heat but total trail erasure",
        "effects": {
          "heat": 35,
          "stamina": -20,
          "thirst": 15,
        ...
        "risk": {
          ...
          "text": "The flames lick higher than you expected. Your fur singes and the smoke fills your lungs like boiling water."
        }
      },
      {
        "key": "flee_fire",
        "name": "Run Parallel",
        "description": "Follow the fire's edge — the smoke confuses tracking",
        "effects": {
          "heat": 15,
          "stamina": -15,
          "thirst": 10,
      ...
      {
        "key": "wait_fire",
        "name": "Wait for it to Pass",
        "description": "Let the fire move on, then cross the burned ground",
        "effects": {
          "heat": 5,
          "stamina": 10,
          "thirst": 5,
    ...
    "choices": [
      {
        "key": "descend",
        "name": "Climb Down",
        "description": "Attempt the descent — the valley promises everything you need",
        "effects": {
          "heat": -20,
          "stamina": -30,
          "thirst": -50,
        ...
        "risk": {
          ...
          "text": "A ledge crumbles under your weight. You scramble, slide, and hit the next outcrop hard. Something in your shoulder screams."
        }
      },
      {
        "key": "along_cliff",
        "name": "Follow the Cliff Edge",
        "description": "Look for an easier descent while moving",
        "effects": {
          "heat": 10,
          "stamina": -10,
          "thirst": 5,
    ...
    "choices": [
      {
        "key": "enter_cave",
        "name": "Enter and Rest",
        "description": "Deep rest in cool darkness — excellent recovery but the hunters gain ground",
        "effects": {
          "heat": -40,
          "stamina": 30,
          "thirst": 0,
      ...
      {
        "key": "entrance_only",
        "name": "Rest at the Entrance",
        "description": "Stay near the light — some shade benefit, less risk",
        "effects": {
          "heat": -20,
          "stamina": 15,
          "thirst": 0,
  ...
  },
  {
    ...
    "choices": [
      {
        "key": "scatter",
        "name": "Scatter Your Trail",
        "description": "Circle the camp to confuse their tracking — costs time but sows doubt",
        "effects": {
          "heat": 15,
          "stamina": -15,
          "thirst": 5,
      ...
      },
      {
        "key": "flee",
        "name": "Run",
        "description": "The sight fills you with dread — push hard away",
        "effects": null,
        "distance": null
      }
    ]
    ...
    "choices": [
      {
        "key": "push",
        "name": "Push Harder",
        "description": "The reminder drives you forward with renewed fear",
        "effects": null,
        "distance": null
      },
      {
        "key": "rest",
        "name": "Rest Despite the Fear",
        "description": "You need recovery more than speed right now",
        "effects": null,
        "distance": null
      }
    ]
  },
  {
    ...
    "choices": [
      {
        "key": "stampede",
        "name": "Run Through the Herd",
        "description": "Trigger a stampede — your tracks vanish in the chaos",
        "effects": {
          "heat": 20,
          "stamina": -20,
          "thirst": 10,
        ...
        "risk": {
          ...
          "text": "A bull clips you as the herd wheels. The impact spins you sideways but you find your feet."
        }
      },
      {
        "key": "skirt_herd",
        "name": "Go Around",
        "description": "Circle the herd quietly",
        "effects": {
          "heat": 10,
          "stamina": -10,
          "thirst": 5,
      ...
      {
        "key": "rest",
        "name": "Rest in Their Shadow",
        "description": "Rest near the herd — their presence masks yours briefly",
        "effects": null,
        "distance": null
      }
    ]
  },
  {
    ...
    "choices": [
      {
        "key": "push",
        "name": "Push Through the Night",
        "description": "Their song drives you forward — pure flight instinct",
        "effects": null,
        "distance": null
      },
      {
        "key": "hide",
        "name": "Go Still",
        "description": "Freeze and hope they pass — movement in the dark is what they track",
        "effects": {
          "heat": -15,
          "stamina": 15,
          "thirst": 0,
  ...
  },
  {
    ...
    "choices": [
      {
        "key": "backtrack",
        "name": "Backtrack and Change Course",
        "description": "Double back to break the trail — costs energy and time",
        "effects": {
          "heat": 15,
          "stamina": -20,
          "thirst": 10,
      ...
      },
      {
        "key": "ignore",
        "name": "Keep Going",
        "description": "Changing course costs too much",
        "effects": null,
        "distance": null
      }
    ]
    ...
    "choices": [
      {
        "key": "rest_bones",
        "name": "Rest Here",
        "description": "Rest beside the bones of the one who came before",
        "effects": {
          "heat": -20,
          "stamina": 15,
          "thirst": 0,
      ...
      },
      {
        "key": "push",
        "name": "Outlast Them",
        "description": "You will not end up like this",
        "effects": null,
        "distance": null
      }
    ]
  },
  {
    ...
    "choices": [
      {
        "key": "drink_elephants",
        "name": "Drink Carefully",
        "description": "Slip between the elephants and drink — they tolerate you, barely",
        "effects": {
          "heat": -10,
          "stamina": -5,
          "thirst": -100,
      ...
      },
      {
        "key": "wait_turn",
        "name": "Wait Your Turn",
        "description": "Wait until the elephants move on, then drink",
        "effects": {
          "heat": 5,
          "stamina": 10,
          "thirst": -100,
    ...
    "choices": [
      {
        "key": "feast",
        "name": "Gorge Yourself",
        "description": "Eat until your belly strains — free food from the sky",
        "effects": {
          "heat": 5,
          "stamina": 5,
          "thirst": -20,
      ...
      {
        "key": "eat_run",
        "name": "Eat While Moving",
        "description": "Snap them from the air as you trot",
        "effects": {
          "heat": 10,
          "stamina": -10,
          "thirst": -10,
      ...
      },
      {
        "key": "ignore",
        "name": "Ignore Them",
        "description": "Every moment stopped is a moment they gain",
        "effects": null,
        "distance": null
      }
    ]
    ...
    "choices": [
      {
        "key": "struggle",
        "name": "Fight Free",
        "description": "Thrash and claw until you pull loose — exhausting but fast",
        "effects": {
          "heat": 25,
          "stamina": -30,
          "thirst": 10,
      ...
      },
      {
        "key": "slow_escape",
        "name": "Move Slowly",
        "description": "Ease out carefully — takes longer but costs less",
        "effects": {
          "heat": 10,
          "stamina": -10,
          "thirst": 5,
  ...
  },
  {
    ...
    "choices": [
      {
        "key": "run_blind",
        "name": "Run in the Mist",
        "description": "Move fast while you're invisible — risk of obstacles but hunters are blind",
        "effects": {
          "heat": 5,
          "stamina": -15,
          "thirst": -10,
        ...
        "risk": {
          ...
          "text": "You slam into a fallen trunk hidden in the white. The impact leaves you winded and limping."
        }
      },
      {
        "key": "trot_mist",
        "name": "Trot Carefully",
        "description": "Move at a steady pace through the mist",
        "effects": {
          "heat": 3,
          "stamina": -10,
          "thirst": -5,
      ...
      {
        "key": "rest_mist",
        "name": "Rest in the Cover",
        "description": "Let the mist hide you while you recover",
        "effects": {
          "heat": -15,
          "stamina": 20,
          "thirst": -5,
  ...
  },
  {
    ...
    "choices": [
      {
        "key": "risk_drink",
        "name": "Drink at the Edge",
        "description": "Creep to the far edge and drink quickly — the hippos may charge",
        "effects": {
          "heat": 10,
          "stamina": -10,
          "thirst": -100,
        ...
        "risk": {
          ...
          "text": "A bull hippo surges from the water. You barely escape the massive jaws, the shockwave of displaced water knocking you sideways."
        }
      },
      {
        "key": "move_on",
    ...
    "choices": [
      {
        ...
        "description": "You are the apex predator here — drive them all off",
        "effects": {
          "heat": 15,
          "stamina": -15,
          "thirst": 5,
      ...
      },
      {
        "key": "share",
        "name": "Eat Alongside",
        "description": "Join the circle — there's enough for all",
        "effects": {
          "heat": 5,
          "stamina": -5,
          "thirst": 5,
      ...
      },
      {
        "key": "leave",
        "name": "Keep Moving",
        "description": "The noise will attract attention",
        "effects": null,
        "distance": null
      }
    ]
  },
  {
    ...
    "choices": [
      {
        "key": "rest_graveyard",
        "name": "Rest Among the Bones",
        "description": "Something about this place brings deep calm — excellent rest",
        "effects": {
          "heat": -25,
          "stamina": 25,
          "thirst": 0,
      ...
      {
        "key": "scavenge_marrow",
        "name": "Crack Bones for Marrow",
        "description": "The old bones still hold sustenance",
        "effects": {
          "heat": 10,
          "stamina": -10,
          "thirst": 5,
      ...
      },
      {
        ...
        "description": "The dead have nothing for the living",
        "effects": null,
        "distance": null
      }
    ]
    ...
    "choices": [
      {
        "key": "hunker",
        "name": "Hunker Down",
        "description": "Find the lowest ground and endure — the storm erases all tracks",
        "effects": {
          "heat": 5,
          "stamina": 10,
          "thirst": 15,
      ...
      {
        "key": "run_with",
        "name": "Run With the Storm",
        "description": "Let the wind carry you — fast but brutal",
        "effects": {
          "heat": 20,
          "stamina": -25,
          "thirst": 20,
      ...
      },
      {
        "key": "shelter",
        "name": "Find Shelter",
        "description": "Search for a rock or depression to shield you",
        "effects": {
          "heat": -5,
          "stamina": 15,
          "thirst": 10,
    ...
    "choices": [
      {
        "key": "drink_rest",
        "name": "Drink and Rest",
        "description": "Drink the bark water and rest in its shade — deep recovery",
        "effects": {
          "heat": -30,
          "stamina": 20,
          "thirst": -100,
      ...
      },
      {
        "key": "drink_go",
        "name": "Drink and Go",
        "description": "Take the water and keep moving",
        "effects": {
          "heat": -5,
          "stamina": -5,
          "thirst": -100,
      ...
      },
      {
        "key": "push",
        "name": "Push Past",
        "description": "No time for wonder",
        "effects": null,
        "distance": null
      }
    ]
    ...
    "choices": [
      {
        "key": "kill_python",
        "name": "Kill and Eat",
        "description": "A python is a significant meal if you can pin its head",
        "effects": {
          "heat": 15,
          "stamina": -15,
          "thirst": -20,
        ...
        "risk": {
          ...
          "text": "The python strikes before you can pin it, coiling around your foreleg. You thrash free but the crush has left the muscle screaming."
        }
      },
      {
        "key": "avoid",
  ...
  },
  {
    ...
    "choices": [
      {
        "key": "push_moon",
        "name": "Run Under the Moon",
        "description": "The visibility and cool air make for excellent running",
        "effects": {
          "heat": 5,
          "stamina": -15,
          "thirst": 5,
      ...
      },
      {
        "key": "trot",
        "name": "Trot Steadily",
        "description": "Conserve energy under the silver light",
        "effects": null,
        "distance": null
      },
      {
        "key": "howl",
        "name": "Stop and Breathe",
        "description": "For one moment, just exist under the moon",
        "effects": {
          "heat": -20,
          "stamina": 15,
          "thirst": 0,
    ...
    "choices": [
      {
        "key": "dig_deep",
        "name": "Dig Deep",
        "description": "Dig into the mud for the last of the water — exhausting but possible",
        "effects": {
          "heat": 15,
          "stamina": -20,
          "thirst": -80,
      ...
      },
      {
        "key": "cross",
        "name": "Cross Quickly",
        "description": "Get across this exposed ground fast",
        "effects": null,
        "distance": null
      }
    ]
    ...
    "choices": [
      {
        ...
        "description": "Their patience fuels your defiance",
        "effects": null,
        "distance": null
      },
      {
        "key": "rest",
        "name": "Rest Beneath Their Gaze",
        "description": "You are still alive. That is what matters.",
        "effects": null,
        "distance": null
      }
    ]
    ...
    "choices": [
      {
        "key": "run_together",
        "name": "Run Together",
        "description": "Two targets are harder to track than one — the confusion may buy time",
        "effects": {
          "heat": 10,
          "stamina": -10,
          "thirst": 5,
      ...
      },
      {
        "key": "separate",
        "name": "Split Apart",
        "description": "Go different ways — the hunters must choose",
        "effects": {
          "heat": 5,
          "stamina": -5,
          "thirst": 5,
    ...
    "choices": [
      {
        "key": "jump_over",
        "name": "Leap Over",
        "description": "Gather yourself and jump — clear the column cleanly",
        "effects": {
          "heat": 5,
          "stamina": -10,
          "thirst": 3,
        ...
        "risk": {
          ...
          "text": "You misjudge the width. Ants swarm your hindquarters before you can shake them — each bite a tiny fire."
        }
      },
      {
        "key": "go_around",
        "name": "Go Around",
        "description": "Follow the column until it narrows enough to cross",
        "effects": {
          "heat": 10,
          "stamina": -5,
          "thirst": 5,
      ...
      {
        "key": "wait",
        "name": "Wait for Them to Pass",
        "description": "Ant columns move on eventually",
        "effects": {
          "heat": -10,
          "stamina": 10,
          "thirst": 3,
  ...
  },
  {
    ...
    "choices": [
      {
        "key": "plunge_pool",
        "name": "Bathe in the Pool",
        "description": "Submerge yourself — total heat and thirst reset, but the hunters hear it too",
        "effects": {
          "heat": -50,
          "stamina": 5,
          "thirst": -100,
      ...
      },
      {
        "key": "drink_go",
        "name": "Drink and Move",
        "description": "Drink deep and keep running",
        "effects": {
          "heat": -10,
          "stamina": -5,
          "thirst": -100,
      ...
      },
      {
        "key": "push",
        "name": "Push On",
        "description": "The sound will draw the hunters",
        "effects": null,
        "distance": null
      }
    ]
    ...
    "choices": [
      {
        "key": "take_burrow",
        "name": "Drive It Off",
        "description": "Chase the porcupine away and use its burrow to rest — cool and hidden",
        "effects": {
          "heat": -25,
          "stamina": 15,
          "thirst": 0,
        ...
        "risk": {
          ...
          "text": "A quill catches you in the shoulder as it flees. The barb holds deep and every movement twists it further."
        }
      },
      {
        "key": "ignore",
        "name": "Leave It",
        "description": "Not worth a mouthful of quills",
        "effects": null,
        "distance": null
      }
    ]
    ...
    "choices": [
      {
        "key": "gorge",
        "name": "Eat Your Fill",
        "description": "Gorge on the freshest carcass — complete hunger and thirst reset",
        "effects": {
          "heat": 10,
          "stamina": 5,
          "thirst": -50,
      ...
      {
        "key": "eat_move",
        "name": "Eat Quickly and Go",
        "description": "Take what you can carry in your belly",
        "effects": {
          "heat": 5,
          "stamina": -5,
          "thirst": -20,
      ...
      {
        "key": "avoid",
        "name": "Skirt the Kill Zone",
        "description": "The smell will attract every predator and scavenger for miles — including the hunters",
        "effects": null,
        "distance": null
      }
    ]
    ...
    "choices": [
      {
        "key": "observe",
        "name": "Watch and Plan",
        "description": "Study their movement pattern and choose your direction wisely",
        "effects": {
          "heat": 5,
          "stamina": 10,
          "thirst": 5,
        ...
        "distance": 0,
        "special": "reveals_hunter_speed"
      },
      {
        "key": "opposite",
        "name": "Run the Opposite Way",
        "description": "Now that you can see them, run directly away",
        "effects": null,
        "distance": null
      },
      {
        ...
        "description": "Cut perpendicular to their path — may confuse tracking",
        "effects": {
          "heat": 10,
          "stamina": -15,
          "thirst": 5,
    ...
    "choices": [
      {
        "key": "collapse",
        "name": "Go to Her",
        "description": "Let go — rest in the shade that is not there",
        "effects": {
          "heat": -30,
          "stamina": -50,
          "thirst": 20,
        ...
        "risk": {
          ...
          "text": "You collapse. When you wake, the sun is directly overhead and the shade was never there. Your body screams as you force it upright."
        }
      },
      {
        "key": "push",
        "name": "Push Past",
        "description": "She is not real. This is how they win — you give up.",
        "effects": null,
        "distance": null
      }
    ]
    ...
    "choices": [
      {
        "key": "test_leg",
        "name": "Walk It Off",
        "description": "Move slowly, test the leg, find out what you have left",
        "effects": {
          "heat": -10,
          "stamina": -15,
          "thirst": 5,
      ...
      {
        "key": "rest_leg",
        "name": "Rest Until It Passes",
        "description": "Lie still and let the leg recover — the hunters gain but the muscle may return",
        "effects": {
          "heat": -15,
          "stamina": 15,
          "thirst": 5,
      ...
      },
      {
        ...
        "description": "The leg works or it does not. Either way, you run.",
        "effects": null,
        "distance": null
      }
    ]
  },
  {
    ...
    "choices": [
      {
        "key": "river_wash",
        "name": "Find Water to Wash",
        "description": "Seek water to clean the wound and break the trail — costs time",
        "effects": {
          "heat": 10,
          "stamina": -20,
          "thirst": -30,
      ...
      {
        "key": "push",
        "name": "Outpace the Blood",
        "description": "Run faster than the trail can lead them",
        "effects": null,
        "distance": null
      }
    ]
  },
  {
    ...
    "choices": [
      {
        "key": "split_trail",
        "name": "Split Your Trail",
        "description": "Double back, cross your own path, create confusion between the parties",
        "effects": {
          "heat": 20,
          "stamina": -25,
          "thirst": 15,
        ...
        "risk": {
          ...
          "text": "The maneuver costs you. Your body no longer has the precision for this kind of trickery."
        }
      },
      {
        "key": "push",
        "name": "Outrun Them Both",
        "description": "You have come this far. You will not stop for anyone.",
        "effects": null,
        "distance": null
      }
    ]
    ...
    "choices": [
      {
        "key": "detour",
        "name": "Wide Detour",
        "description": "Circle far around — if there is one trap there may be others",
        "effects": {
          "heat": 15,
          "stamina": -20,
          "thirst": 10,
      ...
      {
        "key": "careful_path",
        "name": "Pick Through Carefully",
        "description": "Move slowly and read the ground — your eyes are better than theirs",
        "effects": {
          "heat": 5,
          "stamina": -10,
          "thirst": 5,
        ...
        "risk": {
          ...
          "text": "A second trap, hidden better than the first. Your foreleg punches through the covering and you wrench free with a snarl of pain."
        }
      },
      {
        "key": "push",
        "name": "Abandon This Direction",
        "description": "Turn completely — any direction that does not smell of their planning",
        "effects": null,
        "distance": null
      }
    ]
  },
  {
    ...
    "choices": [
      {
        "key": "break_line",
        "name": "Break Through the Fire Line",
        "description": "Sprint between two fires — they cannot cover every gap",
        "effects": {
          "heat": 30,
          "stamina": -25,
          "thirst": 15,
        ...
        "risk": {
          ...
          "text": "The gap was narrower than you thought. Flame licks your flank and the smoke blinds you for three terrible strides."
        }
      },
      {
        "key": "into_dark",
        "name": "Run Into the Dark",
        "description": "Go where they are driving you — it may be a trap, but the fire is certain",
        "effects": {
          "heat": 5,
          "stamina": -15,
          "thirst": 5,
      ...
      {
        "key": "push",
        "name": "Outflank the Crescent",
        "description": "Run perpendicular, try to get around the edge of the fire line",
        "effects": null,
        "distance": null
      }
    ]
    ...
    "choices": [
      {
        ...
        "description": "The unknown might hide you, or kill you, but staying means capture",
        "effects": {
          "heat": 10,
          "stamina": -15,
          "thirst": 10,
      ...
      {
        "key": "stay_known",
        "name": "Stay in Known Land",
        "description": "You know this terrain. It knows you. Maybe that is enough.",
        "effects": null,
        "distance": null
      }
    ]
  },
  {
    ...
    "choices": [
      {
        "key": "rest_ancestors",
        "name": "Rest Among the Old Ones",
        "description": "Something in this place restores what running has taken — deep, ancient rest",
        "effects": {
          "heat": -35,
          "stamina": 30,
          "thirst": -40,
      ...
      },
      {
        "key": "drink_spring",
        "name": "Drink and Move",
        "description": "Take the water and the memory and keep going",
        "effects": {
          "heat": -10,
          "stamina": -5,
          "thirst": -100,
      ...
      {
        "key": "push",
        "name": "This Is Not Your Time",
        "description": "You did not come here to lie down with bones",
        "effects": null,
        "distance": null
      }
    ]
    ...
    "choices": [
      {
        "key": "make_stand",
        "name": "Stop Here",
        "description": "This is the ground. This is the place. No more running.",
        "effects": {
          "heat": -50,
          "stamina": 50,
          "thirst": -30,
      ...
      {
        "key": "push",
        "name": "Run Past Beauty",
        "description": "You have not come twenty days to stop now",
        "effects": null,
        "distance": null
      }
    ]
    ...
    "choices": [
      {
        "key": "accept",
        "name": "Accept It",
        "description": "The answer is the running itself. There was never anything else.",
        "effects": {
          "heat": -10,
          "stamina": 10,
          "thirst": 0,
      ...
      },
      {
        "key": "defy",
        "name": "Defy It",
        "description": "The answer is that the question does not matter. Only the next stride does.",
        "effects": null,
        "distance": null
      }
    ]
  },
  {
    ...
    "choices": [
      {
        "key": "drink_slow",
        "name": "Drink Every Drop",
        "description": "Press your tongue to the stone until the thirst breaks — slow, exposed, necessary",
        "effects": {
          "heat": 5,
          "stamina": -15,
          "thirst": -80,
      ...
      },
      {
        "key": "taste_go",
        "name": "Taste and Go",
        "description": "Wet your tongue and move — something is better than nothing",
        "effects": {
          "heat": 3,
          "stamina": -5,
          "thirst": -30,
      ...
      },
      {
        "key": "push",
        "name": "Move On",
        "description": "Not enough water here to justify the stop",
        "effects": null,
        "distance": null
      }
    ]
...
export const rares: SignatureEntry[] = [
  {
    "id": "rare_eclipse",
    "name": "The Eclipse",
    ...
    "choices": [
      {
        "key": "run_eclipse",
        "name": "Run in the False Night",
        "description": "The darkness and cold are a gift — sprint while the world is stunned",
        "effects": {
          "heat": -40,
          "stamina": -15,
          "thirst": -10,
      ...
      {
        "key": "rest_eclipse",
        "name": "Rest in the Dark",
        "description": "Let the impossible cold wash over you",
        "effects": {
          "heat": -50,
          "stamina": 30,
          "thirst": 0,
  ...
  },
  {
    ...
    "choices": [
      {
        "key": "join_stampede",
        "name": "Run With the Herd",
        "description": "Join the migration — be carried by the tide of bodies",
        "effects": {
          "heat": 15,
          "stamina": -20,
          "thirst": 10,
        ...
        "risk": {
          ...
          "text": "A buffalo clips you. You stumble but the momentum of the herd pushes you forward, bruised but alive."
        }
      },
      {
        "key": "wait_pass",
        "name": "Wait for Them to Pass",
        "description": "Let the herd obliterate every track between you and the hunters",
        "effects": {
          "heat": -10,
          "stamina": 20,
          "thirst": 5,
  ...
  },
  {
    ...
    "choices": [
      {
        "key": "embrace_storm",
        "name": "Embrace the Storm",
        "description": "Stand in the rain and drink from the sky — total reset of heat and thirst",
        "effects": {
          "heat": -60,
          "stamina": 5,
          "thirst": -100,
      ...
      {
        "key": "run_storm",
        "name": "Run in the Deluge",
        "description": "Use the chaos — the lightning, the fire, the rain — to vanish",
        "effects": {
          "heat": -30,
          "stamina": -15,
          "thirst": -100,
  ...
  },
  {
    ...
    "choices": [
      {
        "key": "push_ash",
        "name": "Push Through the Ashfall",
        "description": "Run while the world is erased — everything is hidden",
        "effects": {
          "heat": 10,
          "stamina": -15,
          "thirst": 15,
      ...
      },
      {
        "key": "shelter_ash",
        "name": "Find Shelter",
        "description": "The ash burns the lungs — find cover and wait",
        "effects": {
          "heat": -10,
          "stamina": 15,
          "thirst": 10,
  ...
  },
  {
    ...
    "choices": [
      {
        "key": "follow_matriarch",
        "name": "Follow the Matriarch",
        "description": "Walk with the elephants — slow but completely safe and deeply restorative",
        "effects": {
          "heat": -30,
          "stamina": 20,
          "thirst": -30,
      ...
      },
      {
        "key": "break_away",
        "name": "Break Away",
        "description": "You cannot slow down, even for safety",
        "effects": null,
        "distance": null
      }
    ]
  },
  {
    ...
    "choices": [
      {
        "key": "paradise",
        "name": "Stay and Recover",
        "description": "Drink, eat, rest in paradise — massive recovery but the hunters close in",
        "effects": {
          "heat": -50,
          "stamina": 40,
          "thirst": -100,
      ...
      {
        "key": "drink_eat_go",
        "name": "Drink, Eat, and Go",
        "description": "Take what you need and keep running",
        "effects": {
          "heat": -20,
          "stamina": 5,
          "thirst": -100,
  ...
  },
  {
    ...
    "choices": [
      {
        "key": "run_stars",
        "name": "Run While They Watch the Sky",
        "description": "Seize the moment — the hunters are distracted",
        "effects": {
          "heat": 0,
          "stamina": -10,
          "thirst": 3,
      ...
      },
      {
        "key": "watch",
        "name": "Watch the Sky",
        "description": "You too are a creature of this world. Some things are worth stopping for.",
        "effects": {
          "heat": -20,
          "stamina": 25,
          "thirst": 0,
    ...
    "choices": [
      {
        "key": "swim",
        "name": "Swim the Flood",
        "description": "Risk everything on the crossing — the other side means safety",
        "effects": {
          "heat": -30,
          "stamina": -35,
          "thirst": -100,
        ...
        "risk": {
          ...
          "text": "The current seizes you like a fist. You are tumbled, dragged under, spat out downstream. When you crawl onto the bank, you are broken but alive."
        }
      },
      {
        "key": "follow_bank",
        "name": "Follow the Bank",
        "description": "The river blocks the hunters too — follow it for protection",
        "effects": {
          "heat": 5,
          "stamina": -10,
          "thirst": -50,
  ...
  },
  {
    ...
    "choices": [
      {
        "key": "vanish",
        "name": "Vanish Into the Fog",
        "description": "Zigzag through the white — impossible to track, impossible to follow",
        "effects": {
          "heat": -20,
          "stamina": -10,
          "thirst": -10,
      ...
      },
      {
        "key": "den_up",
        "name": "Den Up",
        "description": "Find a depression and rest — invisible and safe",
        "effects": {
          "heat": -30,
          "stamina": 30,
          "thirst": -5,
  ...
  },
  {
    ...
    "choices": [
      {
        "key": "follow_king",
        "name": "Follow His Path",
        "description": "Walk where the old king walked — the grass erases your trail",
        "effects": {
          "heat": -15,
          "stamina": 5,
          "thirst": 0,
      ...
      },
      {
        ...
        "description": "You are not him. You find your own way.",
        "effects": null,
        "distance": null
      }
    ]
