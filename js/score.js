// Pre-computed from 3000 simulation runs (6 strategies x 500 games)
// Each entry: [value, percent_of_runs_that_scored_lower]
const BASELINE_PERCENTILES = {
  days: [
    [3, 0], [4, 3], [5, 12], [6, 33], [7, 52], [8, 67],
    [9, 76], [10, 84], [11, 89], [12, 92], [13, 94], [14, 95],
    [15, 96], [16, 97], [17, 98], [18, 99]
  ],
  distances: [
    [0, 0], [5, 0], [10, 2], [15, 5], [20, 12], [25, 27],
    [30, 51], [35, 73], [40, 83], [45, 87], [50, 90], [55, 92],
    [60, 93], [65, 94], [70, 96], [75, 96], [80, 97]
  ]
};
