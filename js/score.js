// Pre-computed from 6000 simulation runs (6 strategies x 1000 games, normal difficulty)
// Each entry: [value, percent_of_runs_that_scored_lower]
const BASELINE_PERCENTILES = {
  days: [
    [3, 0], [4, 5], [5, 14], [6, 33], [7, 53], [8, 69],
    [9, 78], [10, 85], [11, 90], [12, 93], [13, 94], [14, 96],
    [15, 97], [16, 98], [17, 99]
  ],
  distances: [
    [0, 0], [5, 0], [10, 2], [15, 5], [20, 12], [25, 26],
    [30, 52], [35, 74], [40, 83], [45, 88], [50, 90], [55, 92],
    [60, 93], [65, 95], [70, 96], [75, 97], [80, 98], [85, 99],
    [90, 99]
  ]
};
